...
ActiveRecord::Schema.define(version: 20180905104611) do
  ...
  add_index "prototype_users", ["prototype_id"], name: "index_prototype_users_on_prototype_id", using: :btree
  add_index "prototype_users", ["user_id"], name: "index_prototype_users_on_user_id", using: :btree
